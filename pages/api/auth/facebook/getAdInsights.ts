...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  try {
    ...
    const url = `https://graph.facebook.com/v${VERSION}/${adAccountId}/insights?fields=${encodeURIComponent(fields)}&access_token=${encodeURIComponent(userAccessToken)}&date_preset=lifetime`;

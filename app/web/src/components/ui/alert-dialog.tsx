  ...
  <AlertDialogPortal>
    ...
    <AlertDialogPrimitive.Content
      ...
      style={{
        ...
        // allow callers to override style prop
 ...
 * We render Radix primitive asChild and use your Button component so colors and hover
 * behaviours come from lib/colors and the Button implementation.
 */

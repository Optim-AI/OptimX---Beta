...
>(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ref={ref}
    className={cn(
      // removed color utility classes; kept layout + animation classes
      "flex cursor-default select-none items-center rounded-sm px-2 py-1.5 text-sm outline-none",
      inset && "pl-8",
      className
    )}
    // base styling from tokens
    style={{
...
>(({ className, children, checked, ...props }, ref) => (
  ...
  >
    <span
      ...
      // make the check stand out using your primary token
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.Separator
    ...
    style={{ backgroundColor: colors.muted, height: "1px" }}
    {...props}
  />
))

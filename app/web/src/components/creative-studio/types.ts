...
export type AdSetup = {
  ...
  /** Marketing hook mechanism (separate from visual format) */
  hookType: HookType;
  /** What the ad should achieve */
  campaignGoal: CampaignGoal;
  /** Who the ad is for — Auto = AI infers */
...
export type AdBuilderData = {
  ...
  creativeStrategy?: {
    ...
    frameworkId?: string;
    productIntelligence?: Record<string, string>;
  };
  adConcepts?: Array<{
    id: string;
    title: string;

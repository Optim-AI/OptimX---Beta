...
const Features: React.FC = () => {
  ...
  const features: Feature[] = [
    ...
    { icon: BarChart3, title: 'Analytics & Insights', description: 'Track results, Optimise spend, and grow smarter.' },
    { icon: Search, title: 'SEO & Content Engine', description: 'Optimise your website, blog, and landing pages for Google without a content team.' },
